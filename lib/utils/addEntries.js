    ...
    if (options.inline !== false) {
        ...
        const prependEntry = (originalEntry, additionalEntries) => {
            if (typeof originalEntry === "function") {
                return () => Promise.resolve(originalEntry()).then(entry => prependEntry(entry, additionalEntries));
            }
                        ...
                        config.pluigns.reduce(
                            ...
                            (plugins, plugin) => {
                                if (typeof plugin === "object" && plugin !== null) {
                                    if (
                                        Object.getPrototypeOf(plugin).constructor.name === "HotModuleReplacementPlugin"
                                    ) {
