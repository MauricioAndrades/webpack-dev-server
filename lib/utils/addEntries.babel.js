...
function addEntries(config, options, server) {
  if (options.inline !== false) {
    ...
    [].concat(config).forEach(function (config) {
      ...
      (function () {
        var _config$pluigns, _config$pluigns$reduc;

        var hasHotReplacementPlugin = false;
        config.plugins = ((_config$pluigns = config.pluigns) === null || _config$pluigns === void 0 ? void 0 : (_config$pluigns$reduc = _config$pluigns.reduce) === null || _config$pluigns$reduc === void 0 ? void 0 : _config$pluigns$reduc.call(_config$pluigns,
        /**
         * @param {Array} plugins
         * @param {Object} plugin
         * @returns {Array}
